  ...
  <UiLayout :hasHeader="false">
    <div class="mt-[25vh]">
      ...
      <div class="mt-10 space-y-4 text-justify leading-7">
        <p>
          我来自甘肃一个小农村，2020年毕业于江苏科技大学工业设计专业，现在南京从事产品经理工作。热爱设计，喜欢研究新东西，偶尔写写代码。
        </p>

        <p>
          我今年
          <NuxtLink to="/life" class="link-color">{{ currentAge }}岁</NuxtLink>
          ，性格内敛，不喜社交，极少在网络上发表内容或与人互动，这自然而然的出现了一种边缘与落寞感，也源于作为社恐的挣扎与救赎，我决定在往后的日子里，在这个独特的
          <NuxtLink to="/note" class="link-color">精神角落</NuxtLink>
          记录自己的想法和生活，幸运的话，也许能让你了解我。
        </p>
